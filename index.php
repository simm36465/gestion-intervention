...
<section>
  ...
  <h3 class="font-weight-bold text-center dark-grey-text pb-2"><?php echo $_SESSION["USER"] ?></h3>
  <hr class="w-header my-4">
  <p class="lead text-center text-muted pt-2 mb-5"><?php echo $_SESSION["TOKEN"] ?></p>
